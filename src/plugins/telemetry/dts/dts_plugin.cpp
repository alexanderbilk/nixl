...
using dts_exporter_plugin_t = nixlTelemetryPluginCreator<nixlTelemetryDTSExporter>;
...
nixl_telemetry_plugin_init() {
    return dts_exporter_plugin_t::create(nixlTelemetryPluginApiVersionV1, "dts", "1.0.0");
}

// Plugin cleanup function
extern "C" NIXL_TELEMETRY_PLUGIN_EXPORT void
nixl_telemetry_plugin_fini() {
    // Nothing to clean up for DTS exporter
}
